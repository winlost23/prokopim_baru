...
class Pantun_pidato extends BaseController
{
    ...
    public function index()
    {
        ...
        return view($this->halaman . 'pidato_pantun', $data);
    }

    public function cari()
    {
        $data['title'] = '| Cari Pantun Pidato';
        $data['menu'] = 'kedua';
        $data['pengaturan'] = $this->pengaturanModel
            ->first();
        ...
        return view($this->halaman . 'pidato_pantuncari', $data);
    }
