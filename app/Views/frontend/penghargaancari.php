            ...
            <div class="grid-box">
                ...
                <div class="search-box">
                    <form role="search" class="search-form" action="<?= base_url('penghargaan/cari') ?>" method="post">
                        ...
                        <select name="created_at" style="width: 30%; border: 1px solid #eeeeee; padding: 10px; font-size: 11px; background-color: white; font-family: 'Lato', sans-serif; color: #999999; text-transform: uppercase;">
